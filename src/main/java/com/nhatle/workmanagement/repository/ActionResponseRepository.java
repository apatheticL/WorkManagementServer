...
//   List<ActionResponse> getAllWorkByUserCreate(@Param(value = "userid")int userid);
    ...
    @Query(nativeQuery = true,
            value = "select action.action_id,action.action_name," +
                    ...
                    " and user_action_report.action_id =action.action_id) as number_finish" +
                    ...
                    "join team on user_team.group_id = team.group_id  where user_profile.profile_id = :profileId " +
                    " order by action.created_time desc ")
